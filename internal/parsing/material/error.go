...
var (
	...
	ErrInvalidSpecularTextureMapLine  = errors.New("mtl parsing error : 'map_Ks' row is invalid")
	ErrInvalidShininessTextureMapLine = errors.New("mtl parsing error : 'map_Ns' row is invalid")
	ErrInvalidDissolveTextureMapLine  = errors.New("mtl parsing error : 'map_d' row is invalid")
